...
class WAConnection extends _5_User_1.WAConnection {
    ...
    async prepareMessageMedia(media, mediaType, options = {}) {
        ...
        const { mediaKey, encBodyPath, bodyPath, fileEncSha256, fileSha256, fileLength } = await Utils_1.encryptedStream(media, mediaType, requiresOriginalForSomeProcessing);
