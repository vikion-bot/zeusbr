...
export declare class WAConnection extends EventEmitter {
    ...
    chatOrderingKey: {
        key: (c: import("./Constants").WAChat) => string; /** When to auto-reconnect */
    ...
    protected fetchRequest: (endpoint: string, method?: Method, body?: any, agent?: Agent, headers?: {
        [k: string]: string;
    }, followRedirect?: boolean) => import("got/dist/source").CancelableRequest<import("got/dist/source").Response<string>>;
